...
//       !eventDetails.startDate.trim() ||
//       !eventDetails.endDate.trim() ||
//       !eventDetails.eventVenueName.trim() ||
...
//     formData.append(
//       "event_setup_start_date",
//       eventDetails.eventSetupStartDate?.format("YYYY-MM-DD")
//     );
//     formData.append(
//       "event_setup_end_date",
//       eventDetails.eventSetupEndDate?.format("YYYY-MM-DD")
//     );
//     formData.append(
//       "rehearsal_date",
//       eventDetails.rehearsalDate?.format("YYYY-MM-DD")
//     );
...
//     formData.append("venue_name", eventDetails.eventVenueName);
//     formData.append(
//       "venue_open_time",
...
//                 onChange={(newDate) =>
//                   handleDateChange("eventSetupStartDate", newDate)
//                 }
...
//                 onChange={(newDate) =>
//                   handleDateChange("eventSetupEndDate", newDate)
//                 }
//                 renderInput={(params) => <TextField {...params} fullWidth />}
//                 sx={{
//                   "& .MuiOutlinedInput-root": {
...
//                 onChange={(newDate) =>
//                   handleDateChange("rehearsalDate", newDate)
//                 }
//                 renderInput={(params) => <TextField {...params} fullWidth />}
//                 sx={{
//                   "& .MuiOutlinedInput-root": {
...
//             <Grid item xs={12}>
//               <TextField
//                 label={<FieldLabel label="Start Date" />}
//                 name="startDate"
...
//             <Grid item xs={12}>
//               <TextField
//                 label={<FieldLabel label="End Date" />}
//                 name="endDate"
...
//                 name="eventVenueName"
//                 value={eventDetails.eventVenueName}
//                 onChange={handleChange}
//                 fullWidth
//                 sx={{
//                   "& .MuiInputLabel-root": {
...
//             venueName={eventDetails.eventVenueName}
//             startTime={
//               eventDetails.startTime
